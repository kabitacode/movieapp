...
class PlayingListScreen extends StatefulWidget {
  const PlayingListScreen({super.key});

  @override
  _PlayingListScreenState createState() => _PlayingListScreenState();
}

class _PlayingListScreenState extends State<PlayingListScreen> {
  final PlayingListController controller = Get.put(PlayingListController());
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "List of movies that are currently in theatres.",
