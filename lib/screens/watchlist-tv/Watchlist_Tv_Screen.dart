...
class WatchlistTvScreen extends StatefulWidget {
  const WatchlistTvScreen({super.key});

  @override
  _WatchlistTvScreenState createState() => _WatchlistTvScreenState();
}

class _WatchlistTvScreenState extends State<WatchlistTvScreen> {
  final WatchlistScreenController controller =
      Get.put(WatchlistScreenController(selectwatchlist: 'tv'));
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                                onTap: () {
                                  Get.to(() =>
                                      DetailTvScreen(movieId: item['id']));
                                },
                                child: Container(
